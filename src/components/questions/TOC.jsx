        ...
        "Mix all questions": {
            ...
            questions: [
                ...
                },
                {
                    ...
                    "options": ["Closure under union", "Closure under intersection", "Closure under complementation", "Closure under context-free substitution"],
                    "correct": 3
                },
                {
                    "id": 290,
                    "question": "Pumping lemma is used to prove:",
                    "options": ["A language is regular", "A language is not regular", "A language is context-free", "A grammar is ambiguous"],
                    "correct": 1
                },
                {
                    "id": 291,
                    "question": "Which of the following automata accepts more languages?",
                    "options": ["DFA", "NFA", "ε-NFA", "All accept same class of languages"],
                    "correct": 3
                },
                {
                    "id": 292,
                    "question": "Context-free languages are not closed under which operation?",
                    "options": ["Union", "Concatenation", "Intersection", "Kleene Star"],
                    "correct": 2
                },
                {
                    "id": 293,
                    "question": "Chomsky Normal Form is applicable to:",
                    "options": ["Regular Grammar", "Context-Free Grammar", "Context-Sensitive Grammar", "Unrestricted Grammar"],
                    "correct": 1
                },
                {
                    "id": 294,
                    "question": "Which problem is undecidable?",
                    "options": ["Membership problem for CFG", "Emptiness problem for DFA", "Equivalence problem for DFA", "Halting problem for Turing Machine"],
                    "correct": 3
                },
                {
                    "id": 295,
                    "question": "The class of languages accepted by Pushdown Automata is:",
                    "options": ["Regular languages", "Context-free languages", "Context-sensitive languages", "Recursive languages"],
                    "correct": 1
                },
                {
                    "id": 296,
                    "question": "Which of the following is true about deterministic PDA?",
                    "options": ["More powerful than NDPDA", "Equal in power to NDPDA", "Less powerful than NDPDA", "Accepts all context-sensitive languages"],
                    "correct": 2
                },
                {
                    "id": 297,
                    "question": "Which of the following is the most powerful grammar?",
                    "options": ["Type 3", "Type 2", "Type 1", "Type 0"],
                    "correct": 3
                },
                {
                    "id": 298,
                    "question": "A Turing Machine can be formally defined as:",
                    "options": ["5-tuple", "6-tuple", "7-tuple", "8-tuple"],
                    "correct": 2
                },
                {
                    "id": 299,
                    "question": "Which of the following is decidable?",
                    "options": ["Halting problem", "Membership problem for DFA", "Equivalence of CFGs", "Post correspondence problem"],
                    "correct": 1
                },
                {
                    "id": 300,
                    "question": "The language L = {a^n b^n | n ≥ 0} is:",
                    "options": ["Regular", "Context-free", "Context-sensitive", "Recursive enumerable but not recursive"],
                    "correct": 1
                },
                {
                    "id": 301,
                    "question": "Which among the following is not recursively enumerable?",
                    "options": ["Complement of recursive language", "Complement of RE language", "Recursive languages", "Context-free languages"],
                    "correct": 1
                },
                {
                    "id": 302,
                    "question": "Which normal form removes useless productions in CFG?",
                    "options": ["CNF", "GNF", "Reduced CFG", "None"],
                    "correct": 2
                },
                {
                    "id": 303,
                    "question": "The language L = { ww | w ∈ {0,1}* } is:",
                    "options": ["Regular", "Context-free", "Context-sensitive", "Recursive"],
                    "correct": 2
                },
                {
                    "id": 304,
                    "question": "Which grammar generates only regular languages?",
                    "options": ["Right linear grammar", "Context-free grammar", "Context-sensitive grammar", "Unrestricted grammar"],
                    "correct": 0
                },
                {
                    "id": 305,
                    "question": "Which machine model defines recursively enumerable languages?",
                    "options": ["Finite Automata", "Pushdown Automata", "Linear Bounded Automata", "Turing Machine"],
                    "correct": 3
                },
                {
                    "id": 306,
                    "question": "Which problem is decidable for DFA?",
                    "options": ["Equivalence", "Emptiness", "Finiteness", "All of these"],
                    "correct": 3
                },
                {
                    "id": 307,
                    "question": "Post Correspondence Problem (PCP) is:",
                    "options": ["Decidable", "Undecidable", "Semi-decidable", "Trivial"],
                    "correct": 1
                },
                {
                    "id": 308,
                    "question": "Rice’s theorem applies to:",
                    "options": ["Context-free languages", "Recursive languages", "Properties of RE languages", "Regular languages"],
                    "correct": 2
                },
                {
                    "id": 309,
                    "question": "Which of the following is the most restrictive grammar?",
                    "options": ["Type 0", "Type 1", "Type 2", "Type 3"],
                    "correct": 3
                },
                {
                    "id": 310,
                    "question": "A DFA with 'n' states can accept maximum distinct strings of length:",
                    "options": ["n", "n-1", "Infinite", "2^n"],
                    "correct": 2
                },
                {
                    "id": 311,
                    "question": "Which operation is not closed for regular languages?",
                    "options": ["Union", "Complement", "Homomorphism", "Intersection with CFL"],
                    "correct": 3
                },
                {
                    "id": 312,
                    "question": "The pumping lemma for context-free languages is used to prove:",
                    "options": ["Language is regular", "Language is not context-free", "Language is context-free", "Grammar is unambiguous"],
                    "correct": 1
                },
                {
                    "id": 313,
                    "question": "Which normal form ensures each production starts with a terminal?",
                    "options": ["CNF", "GNF", "Reduced CFG", "Left Recursion Form"],
                    "correct": 1
                },
                {
                    "id": 314,
                    "question": "Ambiguity in CFG means:",
                    "options": ["Multiple parse trees for some string", "Grammar generates no language", "Grammar generates infinite language", "Grammar has left recursion"],
                    "correct": 0
                },
                {
                    "id": 315,
                    "question": "A non-deterministic finite automata can be simulated by DFA with:",
                    "options": ["Same number of states", "2^n states", "n! states", "n^2 states"],
                    "correct": 1
                },
                {
                    "id": 316,
                    "question": "Which of the following is true?",
                    "options": ["Every regular language is CFL", "Every CFL is regular", "Every CFL is CSL", "Every RE language is recursive"],
                    "correct": 0
                },
                {
                    "id": 317,
                    "question": "Which of the following is not true for RE languages?",
                    "options": ["Closed under union", "Closed under intersection", "Closed under complement", "Closed under concatenation"],
                    "correct": 2
                },
                {
                    "id": 318,
                    "question": "The time complexity of simulating an NFA with k states by a DFA is:",
                    "options": ["O(k)", "O(2^k)", "O(k^2)", "O(k!)"],
                    "correct": 1
                },
                {
                    "id": 319,
                    "question": "Which automata is used for lexical analysis?",
                    "options": ["DFA", "NFA", "PDA", "TM"],
                    "correct": 0
                },
                {
                    "id": 320,
                    "question": "The Halting problem is:",
                    "options": ["Decidable", "Undecidable", "Trivial", "Semi-decidable"],
                    "correct": 1
                },
                {
                    "id": 321,
                    "question": "CFGs are closed under:",
                    "options": ["Union", "Concatenation", "Kleene star", "All of these"],
                    "correct": 3
                },
                {
                    "id": 322,
                    "question": "Which of the following is Type-2 Grammar?",
                    "options": ["Regular Grammar", "Context-Free Grammar", "Context-Sensitive Grammar", "Unrestricted Grammar"],
                    "correct": 1
                },
                {
                    "id": 323,
                    "question": "Which automata accepts L = {a^n b^n | n ≥ 0}?",
                    "options": ["DFA", "NFA", "PDA", "TM"],
                    "correct": 2
                },
                {
                    "id": 324,
                    "question": "Which of the following grammars is unrestricted?",
                    "options": ["Type 3", "Type 2", "Type 1", "Type 0"],
                    "correct": 3
                },
                {
                    "id": 325,
                    "question": "Which of the following languages is not regular?",
                    "options": ["Even number of 0s", "Odd number of 1s", "a^n b^n", "(01)*"],
                    "correct": 2
                },
                {
                    "id": 326,
                    "question": "Which grammar form is useful for top-down parsing?",
                    "options": ["CNF", "GNF", "Unambiguous Grammar", "None"],
                    "correct": 1
                },
                {
                    "id": 327,
                    "question": "The complement of a recursive language is:",
                    "options": ["Recursive", "Not recursive", "RE", "Not RE"],
                    "correct": 0
                },
                {
                    "id": 328,
                    "question": "The language of palindromes over {0,1} is:",
                    "options": ["Regular", "CFL", "CSL", "RE"],
                    "correct": 1
                },
                {
                    "id": 329,
                    "question": "Which of the following describes LBA?",
                    "options": ["Finite Automata", "Pushdown Automata", "TM with restricted tape", "NFA"],
                    "correct": 2
                },
                {
                    "id": 330,
                    "question": "Which of the following problems is decidable?",
                    "options": ["Equivalence of CFGs", "Ambiguity of CFG", "Emptiness of DFA", "Halting problem"],
                    "correct": 2
                },
                {
                    "id": 331,
                    "question": "CFG ambiguity can be removed using:",
                    "options": ["Eliminating left recursion", "Left factoring", "Grammar restructuring", "All of these"],
                    "correct": 3
                },
                {
                    "id": 332,
                    "question": "The set of recursive languages is closed under:",
                    "options": ["Union", "Intersection", "Complement", "All of these"],
                    "correct": 3
                },
                {
                    "id": 333,
                    "question": "The class of context-sensitive languages is accepted by:",
                    "options": ["Finite Automata", "PDA", "Linear Bounded Automata", "TM"],
                    "correct": 2
                },
                {
                    "id": 334,
                    "question": "Which of the following is not true?",
                    "options": ["Every regular language is CFL", "Every CFL is regular", "Every CSL is RE", "Every recursive language is RE"],
                    "correct": 1
                },
                {
                    "id": 335,
                    "question": "Which of the following is undecidable?",
                    "options": ["Equivalence of DFA", "Emptiness of DFA", "Ambiguity of CFG", "Membership of DFA"],
                    "correct": 2
                },
                {
                    "id": 336,
                    "question": "CFG is useful to describe:",
                    "options": ["Lexical structure", "Syntax of programming languages", "Semantics of programs", "Machine instructions"],
                    "correct": 1
                },
                {
                    "id": 337,
                    "question": "The complement of RE language is:",
                    "options": ["Recursive", "Not necessarily RE", "Always RE", "Always recursive"],
                    "correct": 1
                },
                {
                    "id": 338,
                    "question": "The language accepted by DFA is always:",
                    "options": ["Finite", "Infinite", "Regular", "CFL"],
                    "correct": 2
                },
                {
                    "id": 339,
                    "question": "The parse tree is associated with:",
                    "options": ["Automata", "Grammar", "Derivation", "All of these"],
                    "correct": 3
                },
                {
                    "id": 340,
                    "question": "In CFG, left recursion causes problems in:",
                    "options": ["Top-down parsing", "Bottom-up parsing", "Shift-reduce parsing", "None"],
                    "correct": 0
                },
                {
                    "id": 341,
                    "question": "Which is more powerful?",
                    "options": ["DFA", "NFA", "ε-NFA", "All are equivalent"],
                    "correct": 3
                },
                {
                    "id": 342,
                    "question": "CFGs are not closed under:",
                    "options": ["Union", "Concatenation", "Kleene star", "Intersection"],
                    "correct": 3
                },
                {
                    "id": 343,
                    "question": "Chomsky hierarchy has how many types of grammars?",
                    "options": ["2", "3", "4", "5"],
                    "correct": 2
                },
                {
                    "id": 344,
                    "question": "Which of the following is undecidable?",
                    "options": ["Membership problem for DFA", "Equivalence problem for DFA", "Halting problem", "Emptiness problem for DFA"],
                    "correct": 2
                },
                {
                    "id": 345,
                    "question": "A grammar is ambiguous if:",
                    "options": ["It generates no language", "It has multiple leftmost derivations for some string", "It generates only finite language", "It is context-sensitive"],
                    "correct": 1
                },
                {
                    "id": 346,
                    "question": "Which of the following is true?",
                    "options": ["Regular ⊆ CFL ⊆ CSL ⊆ RE", "CFL ⊆ Regular ⊆ CSL", "RE ⊆ Recursive", "CSL ⊆ CFL"],
                    "correct": 0
                },
                {
                    "id": 347,
                    "question": "Which of the following is not a context-free language?",
                    "options": ["a^n b^n", "a^n b^n c^n", "(01)*", "Even number of 0s"],
                    "correct": 1
                },
                {
                    "id": 348,
                    "question": "Which problem is decidable for CFGs?",
                    "options": ["Membership", "Ambiguity", "Equivalence", "Finiteness"],
                    "correct": 0
                },
                {
                    "id": 349,
                    "question": "Which of the following is true about Turing Machines?",
                    "options": ["They can solve all problems", "They can solve all computable problems", "They can solve undecidable problems", "They can only accept regular languages"],
                    "correct": 1
                },
                {
                    "id": 350,
                    "question": "The Halting problem was first proved undecidable by:",
                    "options": ["Alan Turing", "Alonzo Church", "Kleene", "Chomsky"],
                    "correct": 0
                }
